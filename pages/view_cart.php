...
<div class="invoice">
  <div class="row invoice-logo">
      <div class="col-xs-6 invoice-logo-space">
          <img src="./img/logo_unich.jpg" width="80px" class="img-responsive" alt=""> 
      </div>
      <div class="col-xs-6">
          <h2>N° De Factura #<?php echo $idlog ?></h2>
          <span style="float: right; color:red">Documento Sin Autorizar</span>
      </div>
  </div>
  <hr>
  <div class="row">
      <div class="col-xs-4">
          ...
          <ul class="list-unstyled">
              <li><strong>Nombre:</strong> <?php echo $_SESSION['c3_nombre']; ?></li>
              <li><strong>Apellido:</strong> <?php echo $_SESSION['c3_apellido']; ?></li>
                            <li><strong>Correo:</strong> <?php echo $_SESSION['c3_correo']; ?></li>
              <li><strong>Teléfono:</strong> <?php echo $_SESSION['c3_phone']; ?></li>
          </ul>
      </div>
  </div>
  <div class="row">
      ...
      <div class="col-xs-4">
          <div class="well">
              <address>
                  ...
                  echo "<strong>Dirección: </strong>$diradmin <br>";
                  echo "<strong>Rif: </strong>$rifadmin <br>";
                  echo "<strong>Teléfono: </strong>$celadmin <br>";
                  ?>
              </address>
              <address>
      ...
      <div class="col-xs-6 invoice-block">
          ...
          <form role="form" action="?mod=facturas&guarda=guarda" method="post" enctype="multipart/form-data"> 
              ...
              <button class="btn btn-lg green hidden-print margin-bottom-5">
                  Solicitar Productos <i class="fa fa-check"></i>
              </button>
          </form>
      </div>
  </div>
